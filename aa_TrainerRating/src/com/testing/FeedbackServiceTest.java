...
public class FeedbackServiceTest 
{
	...
	public void WhenValidDetailsArePassedFeedbackAddedSuccessfully() throws NoTrainerFoundException 
	{
		...
		assertEquals(trainer,service.addFeedback(trainer));
	}
	...
	{
		Trainer trainer=new Trainer("asd", "dfsf", LocalDate.of(2012, 02, 20),LocalDate.of(2016, 02, 20),6);
		service.addFeedback(trainer);
		HashMap<Integer, Trainer> hmap = service.getTrainerList(6);
